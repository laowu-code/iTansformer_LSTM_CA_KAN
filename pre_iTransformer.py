...
if __name__ == "__main__":
    ...
    model=iTransformer_single(num_variates=5, lookback_len=time_length,
                                          pred_length=1, dim=256, depth=5,heads=6,
                                         num_tokens_per_variate=1, use_reversible_instance_norm=True).to(device)
    ...
    model_name = f"iTransformer_{dataset}"
